			...
			case 101:
				...
				while(true) {
					...
					if(c == 1) {
						...
						//create admin object
						 Admin1 admin = new Admin1(bookid,bookname,authorname,description,genre,Price,free);
				...
				/*
				 * case 102: //Author while(true) { System.out.println("PRESS 1 to ADD Author");
				 * System.out.println("PRESS 2 to DELETE Author");
				 * System.out.println("PRESS 3 to DISPLAY Author");
				 * System.out.println("PRESS 4 to UPDATE Author");
				 * System.out.println("PRESS 5 to EXIT");
				 * 
				 * Scanner sca=new Scanner(System.in); int c=sca.nextInt();
				 * 
				 * if(c == 1) { //Add Author
				 * 
				 * System.out.println("Enter Author id: "); int authorid=0; String
				 * str=sca.next(); try { authorid = Integer.parseInt(str); } catch(Exception e)
				 * { e.printStackTrace(); } System.out.println("Enter Author Name: "); String
				 * authorname = br.readLine(); System.out.println("Enter Book id: "); int
				 * bookid=0; String str1=sca.next(); try { bookid = Integer.parseInt(str1); }
				 * catch(Exception e) { e.printStackTrace(); }
				 * System.out.println("Enter User id: "); int userid = 0; String
				 * str2=sca.next(); try { userid = Integer.parseInt(str2); } catch(Exception e)
				 * { e.printStackTrace(); } //create author object Author1 author = new
				 * Author1(authorid,authorname,bookid,userid); boolean ans =
				 * Author1.insertauthordetails(author); if(ans) {
				 * System.out.println("Author record Inserted Successfully...");
				 * System.out.println("Author Record:" + author); }else {
				 * System.out.println("Some error Occured While Inserting...Please try Again!");
				 * }
				 * 
				 * } else if(c == 2) { //Delete author record
				 * System.out.println("Enter Author ID To Delete: "); int authorid =
				 * sc.nextInt(); boolean f = Author1.deleteauthorrecord(authorid); if(f) {
				 * System.out.println("Author Of ID " + authorid + " Record Deleted... "); }else
				 * { System.out.println("Something Went Wrong.. Please try Again!"); } } else
				 * if(c == 3) { //Display Authors Authortable1.showAllauthorrecords(); } else
				 * if(c == 4) { //Update Author
				 * System.out.println("Enter 1 to UPDATE Author name"); int val = sc.nextInt();
				 * if(val == 1) { //Update Name System.out.println("enter author id"); int
				 * i=sc.nextInt();
				 * 
				 * Authortable1.showauthorrecords(i);
				 * System.out.println("Enter Authorname to UPDATE..."); String authorname =
				 * sca.nextLine();
				 * 
				 * Author1 author= new Author1(); author.setAuthorname(authorname); boolean f =
				 * Author1.updateAuthorRecord(val,authorname,i,author); if(f) {
				 * System.out.println("Author Name Updated Successfully..."); }else {
				 * System.out.println("Something Went Wrong Please try Again!"); } }
				 * 
				 * else { System.out.
				 * println("Hey You have not updated Anything... Please choose option Correctly!"
				 * ); }
				 * 
				 * }
				 * 
